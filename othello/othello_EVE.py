...
def plus_AI(player):
    ...
    vice_centers = [(0, 2), (0, 5), (1, 2), (1, 5), (2, 0), (2, 1), (2, 6), (2, 7), (7, 2), (7, 5), (6, 2), (6, 5),
                    (5, 0), (5, 1), (5, 6), (5, 7)]
        ...
        if game == 1:
            ...
            for x in range(8):
                for y in range(8):
                    ...
                    if board[x][y] == -1:
                        w1 += 1
            score1.score_str = str(b1)
            score2.score_str = str(w1)
            for x in range(8):
                for y in range(8):
            ...
            if player == 1:
                ...
                if pygame.time.get_ticks() - time1 > 10:
                    # random_AI(player)
                    max_AI(player)
                    # plus_AI(player)
                    player = -player
            ...
            if player == -1:
                ...
                if pygame.time.get_ticks() - time2 > 10:
                    # random_AI(player)
                    # max_AI(player)
                    plus_AI(player)
                    player = -player
